...
def insert_data():
    ...
    print("Data Entry : \n",itemId+itemName+itemLastName+itemBirthdate+itemAdresse+itemTel+itemMail)
    ...
    if itemMail == "" or itemMail== " ":
        ...
        insert(str(itemId), str(itemName), str(itemLastName), str(itemBirthdate),
               str(itemAdresse),str(itemTel),str(itemMail))
